...
#Functions/Plots
def vacantPlot():
    dfvt = pd.read_csv('BokehApp/Data/HouseVacants.csv', delimiter=',', header=0)
...
def nonOccupiers():
    ...
    dfne = pd.read_csv('BokehApp/Data/HT_NewExisting.csv', delimiter=',', index_col='Year')
    rX = '2010', '2011','2012','2013','2014','2015','2016', '2017', '2018'
...
def maps():
    ...
    with open('BokehApp/Data/dfjson.json', 'r', encoding='utf8') as openfile: 
        # Reading from json file 
        geo_json = GeoJSONDataSource(geojson=openfile.read())

    palette = viridis(7)[::-1]
    tick_labels = {'100000':'100K','200000':'200K','300000':'300K','400000':'400K','500000':'500K'}
    color_mapper = LinearColorMapper(palette = palette, low = 24000, high = 550000)
    color_bar = ColorBar(color_mapper=color_mapper, label_standoff=6, width = 300, height = 20,
    ...
    p16 = figure(title = 'Irish Population 2016', x_axis_location = None, y_axis_location = None, match_aspect=True,
               tools = 'pan, wheel_zoom, box_zoom, reset, hover, save',
                tooltips = [('County', '@COUNTY'),('2016','@2016')])
    p16.title.align='center'
    p16.patches('xs', 'ys', fill_alpha = 0.7, line_width = 0.5, source = geo_json,
               fill_color = {'field' :'2016', 'transform' : color_mapper})
    ...
    p16.add_layout(color_bar, 'below')

    p11 = figure(title = 'Irish Population 2011', x_axis_location = None, y_axis_location = None, match_aspect=True,
               tools = 'pan, wheel_zoom, box_zoom, reset, hover, save',
                tooltips = [('County', '@COUNTY'),('2011','@2011')])
    p11.title.align='center'
    p11.patches('xs', 'ys', fill_alpha = 0.7, line_width = 0.5, source = geo_json,
               fill_color = {'field' :'2011', 'transform' : color_mapper})
    ...
    p11.add_layout(color_bar, 'below')

    p06 = figure(title = 'Irish Population 2006', x_axis_location = None, y_axis_location = None, match_aspect=True,
               tools = 'pan, wheel_zoom, box_zoom, reset, hover, save',
                tooltips = [('County', '@COUNTY'),('2006','@2006')])
    p06.title.align='center'
    p06.patches('xs', 'ys', fill_alpha = 0.7, line_width = 0.5, source = geo_json,
               fill_color = {'field' :'2006', 'transform' : color_mapper})
    ...
    p06.add_layout(color_bar, 'below')

    p02 = figure(title = 'Irish Population 2002', x_axis_location = None, y_axis_location = None, match_aspect=True,
               tools = 'pan, wheel_zoom, box_zoom, reset, hover, save',
                tooltips = [('County', '@COUNTY'),('2002','@2002')])
    p02.title.align='center'
    p02.patches('xs', 'ys', fill_alpha = 0.7, line_width = 0.5, source = geo_json,
               fill_color = {'field' :'2002', 'transform' : color_mapper})
    ...
    p02.add_layout(color_bar, 'below')
